...
title: kr-ki-prior-authorization-workflow-v1-000010
...
sopkb:
  relation:
    id: kr-ki-prior-authorization-workflow-v1-000010
    ...
    knowledge_piece_id: ki-prior-authorization-workflow-v1-000010
    evidence_id: evidence-ki-prior-authorization-workflow-v1-000010
    review_status: proposed
    confidence: 0.82
    rdf_compatible: true
---
# kr-ki-prior-authorization-workflow-v1-000010
...
- Decision rule: [Prior Authorization Requirements](../rules/rule-ki-prior-authorization-workflow-v1-000010-records.md)
