...
resource: ../sections/safety-policy/section-safety-policy-003.md
tags:
- knowledge
- should
- proposed
...
sopkb:
  ...
  decision_rules:
  - ../rules/rule-ki-safety-policy-v1-000016-should.md
  structured_statement:
    subject: Adverse Event Monitoring
    predicate: should
    object: Clinicians should record severe gastrointestinal symptoms, dehydration
      risk, and suspected pancreatitis symptoms.
---
...
- [evidence-ki-safety-policy-v1-000016](../evidence/evidence-ki-safety-policy-v1-000016.md)
...
- [Adverse Event Monitoring](../rules/rule-ki-safety-policy-v1-000016-should.md)

## Source Context

Clinicians should record severe gastrointestinal symptoms, dehydration risk, and suspected pancreatitis symptoms. [^src-safety-policy]

[^src-safety-policy]: safety policy section `section-safety-policy-003`.
