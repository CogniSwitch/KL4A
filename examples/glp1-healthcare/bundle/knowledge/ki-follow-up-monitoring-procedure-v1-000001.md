...
description: Patients should receive follow-up contact within 14 days after GLP-1
  therapy initiation.
resource: ../sections/follow-up-monitoring-procedure/section-follow-up-monitoring-procedure-002.md
tags:
- knowledge
- should
- proposed
...
sopkb:
  ...
  decision_rules:
  - ../rules/rule-ki-follow-up-monitoring-procedure-v1-000001-should.md
  structured_statement:
    subject: Follow-up Monitoring
    predicate: should
...
- [evidence-ki-follow-up-monitoring-procedure-v1-000001](../evidence/evidence-ki-follow-up-monitoring-procedure-v1-000001.md)
...
- [Follow-up Monitoring](../rules/rule-ki-follow-up-monitoring-procedure-v1-000001-should.md)

## Source Context

Patients should receive follow-up contact within 14 days after GLP-1 therapy initiation. [^src-follow-up-monitoring-procedure]

[^src-follow-up-monitoring-procedure]: follow up monitoring procedure section `section-follow-up-monitoring-procedure-002`.
