...
sopkb:
  rule:
    id: rule-ki-follow-up-monitoring-procedure-v1-000003-requires
    type: SOP Decision Rule
    title: Dose Titration
    ...
    relation_id: kr-ki-follow-up-monitoring-procedure-v1-000003
    okf_path: rules/rule-ki-follow-up-monitoring-procedure-v1-000003-requires.md
  knowledge_piece: ../knowledge/ki-follow-up-monitoring-procedure-v1-000003.md
...
- Knowledge relation: [kr-ki-follow-up-monitoring-procedure-v1-000003](../relations/kr-ki-follow-up-monitoring-procedure-v1-000003.md)
